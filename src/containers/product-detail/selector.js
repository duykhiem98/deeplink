...
const productsRelateSelector = state => state.category.productsRelate;
...
export const getProductsRelateSelector = createSelector(
    productsRelateSelector,
    propsSelector,
    (productsRelate, props) => {
        // console.log(`productsRelate:`, productsRelate);
        // console.log(`props.id:`, props.id);
        return productsRelate && productsRelate.data.filter(dt => dt.id !== props.id) || [];
    }
)